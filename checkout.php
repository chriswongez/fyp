                ...
                <form action="./php/proceedcheckout.php" method="POST">
                    ...
                    <div class="row">
                        <div class="col-50">
                            ...
                            <input type="text" id="fname" name="firstname" placeholder="" value="<?php echo $userfirst ?>">
                            <label for="lname"><i class="fa fa-user"></i> Last Name</label>
                            <input type="text" id="lname" name="lastname" placeholder="" value="<?php echo $userlast ?>">
                            <label for="email"><i class="fa fa-envelope"></i> Email</label>
                            <input type="text" id="email" name="email" placeholder="abc123@exmaple.com" value="<?php echo $useremail ?>">
                            <label for="contact"><i class="fa fa-phone"></i> Contact Number</label>
                            <input type="text" id="contact" name="contact" placeholder="0123456789" value="<?php echo $usercontact ?>">
                            <?php
                            if ($_SESSION['setmethod'] == 'delivery') {
                                echo "<label for='adr'><i class='fa fa-address-card-o'></i> Address</label>
                                <input type='text' id='adr' name='address' placeholder='' value='" . $userAdd . "'>
                                <label for='city'><i class='fa fa-institution'></i> City</label>
                                <input type='text' id='city' name='city' placeholder='' value='" . $userCity . "'>
    
                                <div class='row'>
                                    <div class='col-50'>
                                        <label for='state'>State</label>
                                        <input type='text' id='state' name='state' placeholder='' value='" . $userState . "'>
                                    </div>
                                    <div class='col-50'>
                                        <label for='zip'>Zip</label>
                                        <input type='text' id='zip' name='zip' placeholder='' value='" . $userZip . "'>
                                    </div>
                                </div>";
                            }
                            ?>
                        ...
                        <div class="col-50">
                            ...
                            <div class="row">
                                <div class="col-50">
                                    ...
                                    <input type="text" id="expyear" placeholder="2018" minlength="4" maxlength="4">
                                </div>
                                <div class="col-50">
                                    <label for="cvv">CVV/CVV2</label>
                                    <input type="text" id="cvv" placeholder="352" minlength="3" maxlength="4">
                                </div>
                            </div>
                        </div>
