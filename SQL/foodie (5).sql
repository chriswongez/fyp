...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2021 at 05:58 PM
...
(005, '2021-01-31 15:04:40', 34.59, 'delivery', 'received', 0002),
...
(0002, 'chriswongez', 'cwez3112', 'user', '+601111142344', 'chriswongez@gmail.com', 0, 'Chris', 'Wong', '1234567', 'Shanghai', 'Singapore', 99999);
...
--
ALTER TABLE `orderhistory`
  MODIFY `orderID` int(3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
